...
%%% Report lost characters as errors, see https://www.latex-project.org/news/latex2e-news/ltnews34.pdf
\tracinglostchars=3
...
% Workaround for https://github.com/arnomi/cryptocode/issues/29
\makeatletter\AddToHook{begindocument/end}{\let\pc@original@label\ltx@label}\makeatother
